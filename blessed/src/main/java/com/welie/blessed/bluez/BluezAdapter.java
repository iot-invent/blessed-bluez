 ...
 *
 */
public class BluezAdapter extends AbstractBluetoothObject {
	...
	public BluezAdapter(final Adapter1 _adapter, final String _dbusPath, final DBusConnection _dbusConnection) {
		...
		supportedFilterOptions.put("Pattern", String.class);
	}
	 ...
	 */
	public void setPowered(final boolean _powered) {
	 ...
	 */
	public void setDiscoverable(final boolean _discoverable) {
	...
	public Integer getDiscoverableTimeout() {
		final UInt32 typed = getTyped("DiscoverableTimeout", UInt32.class);
	 ...
	 */
	public void setDiscoverableTimeout(final Integer _discoverableTimeout) {
	 ...
	 */
	public void setPairable(final boolean _pairable) {
	...
	public Integer getPairableTimeout() {
		final UInt32 typed = getTyped("PairableTimeout", UInt32.class);
		return typed != null ? typed.intValue() : null;
	}
	 ...
	 */
	public void setPairableTimeout(final Integer _pairableTimeout) {
	...
	public Integer getDeviceClass() {
		final UInt32 typed = getTyped("Class", UInt32.class);
		return typed != null ? typed.intValue() : null;
	}
	...
	public Boolean isDiscovering() {
		return getTyped("Discovering", Boolean.class);
	}
	...
	public String[] getUuids() {
		final List<?> typed = getTyped("UUIDs", ArrayList.class);
		if (typed != null) {
	 ...
	 */
	public void removeDevice(final Device1 _device) throws BluezFailedException, BluezInvalidArgumentsException {
	 ...
	 */
	public void setDiscoveryFilter(final Map<String, Variant<?>> _filter) throws BluezInvalidArgumentsException, BluezNotReadyException, BluezNotSupportedException, BluezFailedException {

		for (final Entry<String, Variant<?>> entry : _filter.entrySet()) {
			...
			final Class<?> typeClass = supportedFilterOptions.get(entry.getKey());
			if (!typeClass.isAssignableFrom(entry.getValue().getValue().getClass())) {      // FIXED A BUG ON THIS LINE
		...
		if (_filter.containsKey("Transport")) {
			final String transportType = (String) _filter.get("Transport").getValue();
	...
	@Nullable
	public BluezDevice getBluezDeviceByPath(@NotNull final String devicePath) {
		BluezDevice bluezDevice = null;
		final Device1 device = DbusHelper.getRemoteObject(getDbusConnection(), devicePath, Device1.class);
		if (device != null) {
	...
	@NotNull
	public String getPath(final String deviceAddress) {
